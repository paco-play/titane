...
| Scene camera | `addComponent(world, entity, Camera, createCamera())`. Play / game look through the `current` one. `projection: 'orthographic'` + `orthoSize` in Play / game; edit orbit stays perspective. |
